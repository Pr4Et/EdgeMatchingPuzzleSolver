...
Installation and running in Windows
...
5. The prompt Eternity folder requires a working directory that includes the files origin6.mat and origin_virtual.mat. Copy and paste the full path name.
